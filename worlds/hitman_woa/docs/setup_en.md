...
If your Peacock Server is not running locally on your machine or is using a different port than default, you must change the address and port that the Client uses to connect to Peacock in the `host.yaml` of your Archipelago installation.
